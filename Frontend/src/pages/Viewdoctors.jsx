...
const DeleteModal = ({ doctor, onConfirm, onCancel, loading }) => (
  <div className="fixed inset-0 z-100 flex items-center justify-center px-4 bg-slate-900/40 backdrop-blur-sm">
    <div className="bg-white p-8 w-full max-w-sm rounded-[2.5rem] shadow-2xl">
      ...
      <h3 className="text-lg font-bold text-slate-900 text-center mb-1">Delete Doctor?</h3>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 bg-rose-50 text-rose-500 text-[10px] font-bold rounded-lg hover:bg-rose-500 hover:text-white transition-all border border-rose-100"
                        >
                          DELETE
                        </button>
                      </div>
