...
const Doctorregister = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#f8fafc] bg-[radial-gradient(ellipse_at_top,#f5f3ff,#f8fafc)] font-sans overflow-hidden py-10">
      ...
      <div className="relative z-10 w-full max-w-125 p-10 bg-white/80 backdrop-blur-xl rounded-[2.5rem] border border-white shadow-[0_30px_60px_-15px_rgba(147,51,234,0.1)] mx-4">
