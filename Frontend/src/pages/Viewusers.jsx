...
const Avatar = ({ name }) => {
  const initials = name
    ...
    : "?";
  return (
    <div className="w-9 h-9 rounded-xl bg-linear-to-br from-violet-100 to-purple-100 border border-violet-100 flex items-center justify-center text-violet-600 font-black text-xs shrink-0">
      {initials}
    </div>
  );
};
